...
bool Person2::operator != (const Person2 &rhs) const
{
    return person.year != rhs.person.year ||
    strcmp(person.lastName,rhs.person.lastName) !=0 ||
    strcmp(person.firstName,rhs.person.firstName) !=0;
}
